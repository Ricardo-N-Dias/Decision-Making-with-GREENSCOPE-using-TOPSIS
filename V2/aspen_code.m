...
Simulation_Name = 'Simulation 1 purge';% Aspeen Plus Simulation Name
...
streams_mixed = ["GPURGE"];

equipment_strings.pump = ["P1" "H-COMP" "H-COMP1" "H-COMP2" "H-COMP3" "H-COMP4" "H-TURB" "H-TURB1" "H-TURB2" "M-COMD" "M-COMD1" "M-COMD2" "H-COMP" "M-COMP1" "M-COMP2" "M-TURB" "ST"];
...
equipment_strings.HE = ["C-1"	"C-2"	"C-2A"	"C-2B"	"C-3"	"COND"	"CSPURGE"	"H-1"	"H-COMPC1"	"H-COMPC2"	"H-COMPC3"	"H-COMPC4"	"H-TURBH1"	"H-TURBH2"	"M-COMDC1"	"M-COMDC2"	"M-COMPC1"	"M-COMPC2"	"QFRESH"];
...
if equipment_strings.other ~= ""
    equipment.other = [""]; %don't have energy consumption
    %
    %Separator, heat E121, power E122
...
filename      = "C:\Users\RDias\OneDrive - Universidade de Lisboa\SoCaLTES_task5\Matlab\CaL\V2\V2.xlsx";
...
Number_of_Outlet_streams = 3;


test = equipment_strings.pump;
test = cellstr(test);
test(2,:) = num2cell(nodes.equipmentenergy.pump);
test(3,[1,2,3,4,5,6,10,11,12,13,14,15,16,17]) = num2cell(nodes.equipmentenergy.pump([1,2,3,4,5,6,10,11,12,13,14,15,16,17]));
test(4,[7,8,9,13,14,15,16]) = num2cell(nodes.equipmentenergy.pump([7,8,9,13,14,15,16]).*2);

total_energy = sum(cell2mat(test(3,:))) + sum(cell2mat(test(4,:)));

save("V2.mat")
% filename      = "C:\Users\RDias\OneDrive - Universidade de Lisboa\SoCaLTES_task5\GREENSCOPE\CaL\GRNS SoCaLTES - V6.xlsm";
